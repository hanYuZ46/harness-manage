...
const SAMPLE_LATEST_ASSET = {
  name: "harness-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/hanYuZ46/harness-manage/releases/download/v0.2.14/harness-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "harness-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/hanYuZ46/harness-manage/releases/download/v0.2.13/harness-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/hanYuZ46/harness-manage/releases/tag/${overrides.tag}`,
