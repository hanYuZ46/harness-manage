      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Opening Harness Manager</CardTitle>
            <CardDescription>
              You should see a prompt to open the Harness Manager desktop app. If
